...
let tarjetas = document.getElementById("tarjeta");


let producto = [{"id":1,"title":"Fjallraven - Foldsack No. 1 Backpack, Fits 15 Laptops",
        "price":109.95,
    ...
    description.textContent=producto.rating;
...
getProducto()
           ...
           /* for( let i=0; i<producto.length; i++){
                ...
                tarjetas.appendChild(price);
                tarjetas.appendChild(description);
                tarjetas.appendChild(category);
                tarjetas.appendChild(rating);
